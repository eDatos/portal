    ...
    <div>
	    <c:choose>
		    <c:when test="${content.value.ApiUrlStatisticalResources == ''
                ...
                || content.value.ApiUrlPermalinks == ''
                || content.value.ApiUrlExport == ''
			...
			<c:otherwise>
		        ...
		        <script>
		            LazyLoad.css('<cms:link>/system/modules/org.siemac.metamac.metamac-portal/resources/metamac.css</cms:link>?d=${cssDate}', function () {
		                LazyLoad.js('<cms:link>/system/modules/org.siemac.metamac.metamac-portal/resources/metamac.js</cms:link>?d=${jsDate}', function () {
						    ...
						    if (lowerThanIE9()) {
			                    ...
			                    App.endpoints["permalinks"] = "${content.value.ApiUrlPermalinks}/v1.0";
			                    
			                    // http://estadisticas.arte-consultores.com/export
			                    App.endpoints["export"] = "${content.value.ApiUrlExport}/v1.0";
			                    ...
			                    LazyLoad.js("${content.value.ApiUrlStatisticalVisualizer}/js/authentication.js?d=${jsDate}", function() {
