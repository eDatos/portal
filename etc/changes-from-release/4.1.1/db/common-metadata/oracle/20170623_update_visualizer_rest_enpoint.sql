...
UPDATE TB_DATA_CONFIGURATIONS SET CONF_VALUE = 'FILL_ME' WHERE CONF_KEY = 'metamac.portal.rest.external.base';
UPDATE TB_DATA_CONFIGURATIONS SET CONF_VALUE = 'FILL_ME' WHERE CONF_KEY = 'metamac.portal.web.external';
UPDATE TB_DATA_CONFIGURATIONS SET CONF_VALUE = 'FILL_ME' WHERE CONF_KEY = 'metamac.portal.web.internal';
...
-- UPDATE TB_DATA_CONFIGURATIONS SET CONF_VALUE = 'http://estadisticas.arte-consultores.com/statistical-visualizer-api' WHERE CONF_KEY = 'metamac.portal.rest.external.base';
-- UPDATE TB_DATA_CONFIGURATIONS SET CONF_VALUE = 'http://estadisticas.arte-consultores.com/statistical-visualizer' WHERE CONF_KEY = 'metamac.portal.web.external';
-- UPDATE TB_DATA_CONFIGURATIONS SET CONF_VALUE = 'http://estadisticas.arte-consultores.com/statistical-visualizer-internal' WHERE CONF_KEY = 'metamac.portal.web.internal';
