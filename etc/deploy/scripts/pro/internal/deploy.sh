...
scp -o "StrictHostKeyChecking=no" metamac-portal-web/target/statistical-visualizer-*.war deploy@mgdelicias.gobiernodecanarias.net:$TRANSFER_PATH/statistical-visualizer-internal.war
