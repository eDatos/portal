...
public class PortalConfigurationConstants extends ConfigurationConstants {
    ...
    // VISUALIZER STYLES
    public static final String PORTAL_DEFAULT_STYLE_HEADER_URL     = "metamac.portal.default.style.header.url";
    public static final String PORTAL_DEFAULT_STYLE_CSS_URL        = "metamac.portal.default.style.css.url";
    public static final String PORTAL_DEFAULT_STYLE_FOOTER_URL     = "metamac.portal.default.style.footer.url";
