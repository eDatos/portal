package com.stat4you.web.server.servlet;
...
/**
 * <p>
 * A ServletContextListner that can be used to initialize Quartz. Extract from Quartz for added externalised quartz configuration.
 * </p>
 * <p>
...
public class QuartzInitializerListener implements ServletContextListener {
    ...
    private void createJobsCron() throws Exception {
        // Crawlers Jobs
        log.info("Scheduling crawler jobs...");
        CrawlerUtil.addCronTrigers();
        log.info("Scheduling crawler jobs finished");
    }
