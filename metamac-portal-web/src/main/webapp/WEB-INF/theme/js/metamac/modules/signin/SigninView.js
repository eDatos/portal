(function () {
    ...
    App.namespace("App.modules.signin");

    App.modules.signin.SigninView = Backbone.View.extend({

        template : App.templateManager.get('signin/signin'),
        ...
        saveRedirectCookie : function (url) {
            Cookies.set("App.login.redirect", url, { expires : 600 });
        },
        ...
        signin : function (e) {
            ...
            this.redirectUrl()
                .done(function (url) {
                    ...
                    var req = App.track({event : 'login', provider : provider});
                    req.always(function () {
