(function () {
    ...
    App.namespace("App.modules.comments.CommentView");

    App.modules.comments.CommentView = Backbone.View.extend({

        template : App.templateManager.get('comments/comments-comment'),

        templatePopover : App.templateManager.get('comments/comments-comment-delete-popover'),
        ...
        render : function () {
            var userIdentifier;
            if (App.user) {
                userIdentifier = App.user.get('identifier');
            }
