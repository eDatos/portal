(function () {
    ...
    App.namespace("App.modules.comments.CommentsView");

    var CommentView = App.modules.comments.CommentView,
        Comment = App.modules.comments.Comment;

    App.modules.comments.CommentsView = Backbone.View.extend({
        ...
        template : App.templateManager.get('comments/comments-page'),
        counterTemplate : App.templateManager.get('comments/comments-counter'),
        paginationTemplate : App.templateManager.get('comments/comments-pagination'),
        ...
        submit : function () {
            ...
            var comment = new Comment({
                user : {
                    identifier : App.user.get('identifier')
                },
                content : content,
