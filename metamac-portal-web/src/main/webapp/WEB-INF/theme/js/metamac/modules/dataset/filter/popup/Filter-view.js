...
App.widget.filter.FilterView = Backbone.View.extend({
    _templateExternalContainer : App.templateManager.get('widget/filter/popup/filter-external-container'),
    _templateTableContainers : App.templateManager.get('widget/filter/popup/filter-table-containers'),
    _templateColumnContainers : App.templateManager.get('widget/filter/popup/filter-column-containers'),
    _templateLineContainers : App.templateManager.get('widget/filter/popup/filter-line-containers'),
    _templatePieContainers : App.templateManager.get('widget/filter/popup/filter-pie-containers'),
    _templateMapContainers : App.templateManager.get('widget/filter/popup/filter-map-containers'),
