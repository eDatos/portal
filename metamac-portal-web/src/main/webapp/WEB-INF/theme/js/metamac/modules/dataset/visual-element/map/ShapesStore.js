(function () {
    ...
    App.Map.ShapesStore = function () {
        var self;
        if (App.Map.ShapesStore.hasIndexedDbSupport()) {
            self = new App.Map.ShapesIndexedDbStore();
        } else {
            self = new App.Map.ShapesHashStore();
        }
        return self;
    };

    App.Map.ShapesStore.hasIndexedDbSupport = function () {
        return !_.isUndefined(indexedDB);
    };

    App.Map.ShapesIndexedDbStore = function () {
    };

    App.Map.ShapesIndexedDbStore.prototype = {
        ...
        _dbOpen : function () {
            ...
            if (this._db) {
                ...
                var version = parseInt(App.configuration["map.version"], 10) || 1;
    ...
    App.Map.ShapesHashStore = function () {
        this.clear();
    };

    App.Map.ShapesHashStore.prototype = {
