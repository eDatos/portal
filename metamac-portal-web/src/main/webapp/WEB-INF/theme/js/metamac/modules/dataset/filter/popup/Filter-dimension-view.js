...
App.widget.filter.FilterDimensionView = Backbone.View.extend({
    _templateDimension : App.templateManager.get('widget/filter/popup/filter-dimension'),
    _templateDimensionCategories : App.templateManager.get('widget/filter/popup/filter-dimension-categories'),
    _templateDimensionCheckbox : App.templateManager.get('widget/filter/popup/filter-dimension-checkbox'),
