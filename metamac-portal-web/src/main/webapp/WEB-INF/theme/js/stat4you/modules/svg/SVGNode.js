(function () {
    ...
    STAT4YOU.namespace('STAT4YOU.svg.SVGNode');

    var xmlns = "http://www.w3.org/2000/svg";

    STAT4YOU.svg.SVGNode = function (name) {
        if (_.isString(name)) {
            this.name = name;
    ...
    STAT4YOU.svg.SVGNode.factory = function (name, n) {
        n = n || 1;
        var result = [];
        for(var i = 0; i < n; i++) {
            result.push(new STAT4YOU.svg.SVGNode(name));
        }
        return result;
    };

    STAT4YOU.svg.SVGNode.prototype = {
