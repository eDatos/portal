(function () {
    ...
    var Cell = STAT4YOU.Table.Cell,
        ...
        Tooltip = STAT4YOU.components.tooltip.Tooltip;
    ...
    STAT4YOU.Table.View.prototype.forceRepaint = function () {
        this.clear();
        this.leftHeaderZone.calculateIncrementalSize();
        this.topHeaderZone.calculateIncrementalSize();
    ...
    STAT4YOU.Table.View.prototype.update = function () {
        this.setZonesViewPorts();
        this.forceRepaint();
    };
    ...
    STAT4YOU.Table.View.prototype.destroy = function () {
        this.tooltip.destroy();
    };

    STAT4YOU.Table.View.prototype.columnSeparatorIndex = function (point) {
        var pointRectangle = Rectangle.createFromPointWithOffset(point);
        return this.topHeaderZone.separatorIndexInRectangle(pointRectangle);
    };

    STAT4YOU.Table.View.prototype.leftColumnHeaderSeparatorIndex = function (point) {
        var pointRectangle = Rectangle.createFromPointWithOffset(point);
        return this.leftHeaderZone.separatorIndexInRectangle(pointRectangle);
    };

    STAT4YOU.Table.View.prototype.resizeColumnWidth = function (separatorIndex, distance) {
    ...
    STAT4YOU.Table.View.prototype.resizeLeftHeaderColumnWidth = function (separatorIndex, distance) {
