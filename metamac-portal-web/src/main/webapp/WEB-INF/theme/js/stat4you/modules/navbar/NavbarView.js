(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.modules.navbar.NavbarView");

    STAT4YOU.modules.navbar.NavbarView = Backbone.View.extend({

        template : STAT4YOU.templateManager.get('navbar/navbar'),
