...
STAT4YOU.widget.filter.FilterDimensionView = Backbone.View.extend({
    _templateDimension : STAT4YOU.templateManager.get('widget/filter/filter-dimension'),
    _templateDimensionCategories : STAT4YOU.templateManager.get('widget/filter/filter-dimension-categories'),
    _templateDimensionCheckbox : STAT4YOU.templateManager.get('widget/filter/filter-dimension-checkbox'),
    ...
    _renderCheckbox : function() {
        var dim = this.model.getDimension(this.dimNum);
        this.$checkbox = this._templateDimensionCheckbox({allSelected : this.model.areAllCategoriesSelected(dim.number)});
    ...
    _handleToggleCategory : function(e) {
        ...
        var $dimension = $category.parents('.div-dimension-short');
