(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.VisualElement");

    STAT4YOU.VisualElement.Base = function (options) {
        this.initialize(options);
    };

    STAT4YOU.VisualElement.Base.prototype = {
    ...
    _.extend(STAT4YOU.VisualElement.Base.prototype, Backbone.Events);
