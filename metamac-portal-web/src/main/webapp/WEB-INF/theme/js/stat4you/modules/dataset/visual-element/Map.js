(function () {
    ...
    STAT4YOU.namespace('STAT4YOU.VisualElement.Map');

    STAT4YOU.VisualElement.Map = function (options) {
        this.initialize(options);
    };

    STAT4YOU.VisualElement.Map.prototype = {
        ...
        initialize : function (options) {
            ...
            this.shapes = new STAT4YOU.Map.Shapes();
            this.visible = false;
        },
        ...
        _initModel : function () {
            this._mapModel = new STAT4YOU.Map.MapModel();
        },

        _initContainerView : function () {
            this._mapContainerView = new STAT4YOU.Map.MapContainerView({
                el : this.el,
    ...
    _.defaults(STAT4YOU.VisualElement.Map.prototype, STAT4YOU.VisualElement.Base.prototype);
    _.extend(STAT4YOU.VisualElement.Map.prototype, Backbone.Events);
