(function () {
    ...
    STAT4YOU.Table.Zone.prototype.isRelativeRectangleVisible = function (rectangle) {
        return this.isRelativePointVisible(rectangle.topLeftPoint()) ||
               this.isRelativePointVisible(rectangle.topRightPoint()) ||
               this.isRelativePointVisible(rectangle.bottomLeftPoint()) ||
               this.isRelativePointVisible(rectangle.bottomRightPoint());
    };
