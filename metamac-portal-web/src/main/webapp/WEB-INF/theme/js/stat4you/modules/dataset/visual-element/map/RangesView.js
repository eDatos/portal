(function () {
    ...
    STAT4YOU.namespace('STAT4YOU.Map.RangesView');
    
    STAT4YOU.Map.RangesView = Backbone.View.extend({
        _templateRanges : STAT4YOU.templateManager.get('widget/map/map-ranges'),
