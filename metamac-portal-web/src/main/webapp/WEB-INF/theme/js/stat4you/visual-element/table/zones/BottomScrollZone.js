(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.Table.BottomScrollZone");

    STAT4YOU.Table.BottomScrollZone = function (options) {
        STAT4YOU.Table.Zone.prototype.initialize.apply(this, arguments);
        this.initialize(options);
    };

    STAT4YOU.Table.BottomScrollZone.prototype = {
    ...
    _.defaults(STAT4YOU.Table.BottomScrollZone.prototype, STAT4YOU.Table.Zone.prototype);
