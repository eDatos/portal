(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.dataset.data.BigDataCache");
    
    var BigDataCacheBlock = STAT4YOU.dataset.data.BigDataCacheBlock;

    STAT4YOU.dataset.data.BigDataCache = function (options) {
    ...
    STAT4YOU.dataset.data.BigDataCache.prototype = {
        ...
        initialize : function () {
            ...
            for(var i = 0; i < this.cacheSize.rows; i++) {
                ...
                for (var j = 0; j < this.cacheSize.columns; j++) {
                    this._cacheBlockForIndex({x : j, y : i});
                }
            }
        },
        ...
        _updateLRU : function (cacheBlock) {
            ...
            if(!current){
                ...
                if(removed) {
                    this.cache[removed.value.index.y][removed.value.index.x] = undefined;
                }
            }
        },
