(function () {
    ...
    var ProfileFavouritesView = STAT4YOU.modules.profile.ProfileFavouritesView;
    var Datasets = STAT4YOU.modules.datasets.Datasets;

    STAT4YOU.modules.profile.ProfileReadView = Backbone.View.extend({

        template : STAT4YOU.templateManager.get('profile/profile-read'),
