(function(){
    ...
    A.IssueDialog.prototype = {hideDialog : undefined, updateContainerPosition : function(){
        ...
        var R = this, N = A("#atlwdg-container"), Q = A("body"), O = A('<iframe id="atlwdg-frame" frameborder="0" src=""></iframe>'), J = A('<img class="atlwdg-loading" style="display:none;" src="' + STAT4YOU.resourceContext + 'images/jira_loading.gif">');
