(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.modules.profile.ProfileFavouritesView");

    STAT4YOU.modules.profile.ProfileFavouritesView = Backbone.View.extend({
        ...
        appendDataset : function (dataset, animation) {
            var datasetModel = new STAT4YOU.modules.datasets.Dataset(dataset);
            var view = new STAT4YOU.modules.datasets.DatasetView({dataset : datasetModel});
            view.render();
