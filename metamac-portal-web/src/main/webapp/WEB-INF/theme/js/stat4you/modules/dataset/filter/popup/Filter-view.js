...
STAT4YOU.widget.filter.FilterView = Backbone.View.extend({
    _templateExternalContainer : STAT4YOU.templateManager.get('widget/filter/popup/filter-external-container'),
    _templateTableContainers : STAT4YOU.templateManager.get('widget/filter/popup/filter-table-containers'),
    _templateColumnContainers : STAT4YOU.templateManager.get('widget/filter/popup/filter-column-containers'),
    _templateLineContainers : STAT4YOU.templateManager.get('widget/filter/popup/filter-line-containers'),
    _templatePieContainers : STAT4YOU.templateManager.get('widget/filter/popup/filter-pie-containers'),
    _templateMapContainers : STAT4YOU.templateManager.get('widget/filter/popup/filter-map-containers'),
