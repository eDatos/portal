(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.Table.TopHeaderZone");

    STAT4YOU.Table.TopHeaderZone = function (options) {
        STAT4YOU.Table.Zone.prototype.initialize.apply(this, arguments);
        this.initialize(options);
    };

    _.extend(STAT4YOU.Table.TopHeaderZone.prototype, STAT4YOU.Table.Zone.prototype);

    STAT4YOU.Table.TopHeaderZone.prototype.initialize = function (options) {
        if (!options) {
            options = {};
        }
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.calculateIncrementalSize = function () {
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.paintInfo = function () {
        ...
        for (var i = 0; i < rowsLen; i++) {
            ...
            for (var j = 0; j < bodyPaintInfo.columns.length; j++) {
                ...
                if (result[i].length === 0 || _.last(result[i]).index != index) {
                    ...
                    var content = rowsValues[i][indexInValue % rowsValuesLength[i]];
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.cellAtPoint = function (absolutePoint) {
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.titleAtPoint = function (absolutePoint) {
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.columnsAtPoint = function (absolutePoint) {
        var headerCellAtPoint = this.cellAtPoint(absolutePoint);
        if(headerCellAtPoint) {
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.repaint = function () {
        this.clear();
        this.paintShadow();
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.paintShadow = function () {
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.paintGrid = function () {
        this.ctx.save();
        this.ctx.beginPath();
    ...
    STAT4YOU.Table.TopHeaderZone.prototype.paintCells = function (paintInfo) {
        this.ctx.save();
