(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.Table.BodyZone");

    STAT4YOU.Table.BodyZone = function (options) {
        STAT4YOU.Table.Zone.prototype.initialize.apply(this, arguments);
        this.initialize(options);
    };

    STAT4YOU.Table.BodyZone.prototype = {
        ...
        isCellVisible : function (cell) {
            ...
            var topRight = new Point(topLeft.x + size.width - 1, topLeft.y);
            var bottomLeft = new Point(topLeft.x, topLeft.y + size.height - 1);
            var bottomRight = new Point(topLeft.x + size.width - 1, topLeft.y + size.height - 1);

            return this.isRelativePointVisible(topLeft) ||
                this.isRelativePointVisible(topRight) ||
                this.isRelativePointVisible(bottomLeft) ||
                this.isRelativePointVisible(bottomRight);
        },
    ...
    _.defaults(STAT4YOU.Table.BodyZone.prototype, STAT4YOU.Table.Zone.prototype);
}());
