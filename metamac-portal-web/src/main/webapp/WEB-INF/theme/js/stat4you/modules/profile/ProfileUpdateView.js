(function () {
    ...
    STAT4YOU.namespace("STAT4YOU.modules.profile.ProfileUpdateView");

    STAT4YOU.modules.profile.ProfileUpdateView = Backbone.View.extend({

        template : STAT4YOU.templateManager.get('profile/profile-update'),
        ...
        initialize : function (options) {
            ...
            this.navBarView = STAT4YOU.navbarView;
        ...
        _redirectFromLogin : function () {
            ...
            var redirectFromLoginUrl = Cookies.get("stat4you.login.redirect");
        ...
        _reloadProfilePage : function () {
            if (!this._redirectFromLogin()) {
                window.location = STAT4YOU.context + "/profile";
            }
        },
